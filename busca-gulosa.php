...
<div class="content-wrapper">
	<div class="content-header">
		<div class="container">
			<div class="row my-3">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Gulosa</h1>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	</div><!-- /.content-header -->
			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						...
						<div class="card-body">
							Sempre seleciona o caminho que tenha: o menor valor heurístico, ou a menor distância (custo) estimada.</li>
			...
			if(!empty($valor) && $ponto == $temp_caminho){	//Verifica se o nó possui filho
				foreach ($valor as $vetor => $valor) {	//Percorre os filhos do nó
					if(!empty($valor)){
						...
						else if($heuristica[$vetor] < $temp_valor){	//Verifica se o valor da heuristica e menor
				...
				if(in_array($objetivo, $caminho)) //Verifica se no objetivo esta na lista
					break;
			}	
		}
	}
